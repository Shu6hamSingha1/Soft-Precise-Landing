#!/usr/bin/env bash
# Manuscript-gain combined-barrier (NEW BAKED default) vs back-mapped, IC2-5 gate.
set -u
...
run_cell () {
  ...
  local base="$PROJ/test_data/VdfBake_${ic}_${arm}"; mkdir -p "$base"

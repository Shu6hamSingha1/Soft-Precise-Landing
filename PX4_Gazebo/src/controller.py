...
class Controller(Thread):
    def __init__(self, ref_rad_opt_flow, des_img_feature, time_keeper=time, controller=None, record='n'):
        ...
        self._combined_barrier = os.environ.get("PLASMC_COMBINED_BARRIER", "0") == "1"  # REVERTED 2026-06-20 (regresses IC2-5; feedback_combined_barrier_zeta_r_blowup)
        ...
        self._vds_kf = os.environ.get("PLASMC_VDS_KF", "0") == "1"   # default-off (validated estimator, but tied to combined which reverted)

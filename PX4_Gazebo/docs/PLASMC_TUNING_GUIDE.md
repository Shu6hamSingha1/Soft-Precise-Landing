...
- **All gain-side levers exhausted under R3; the binding TL cause is PERCEPTION** (2026-06-10 TL analysis of 6 TLs: **4/6 perception** — 3 close-range *touchdown* marker-loss @ xy 1–3 m + 1 far drift 20 m; only 2/6 control κ-runaway). Next real lever: **code-level perception** (pyramidal LK 2→3 in `img_data.getLKFlowAngVel`) + the **IC-rig compass-drift fix** for IC2-5 yaw. Knob sweeps will not move the needle.

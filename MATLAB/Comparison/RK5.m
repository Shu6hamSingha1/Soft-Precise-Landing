...
%
% Reference:
% Meysam Mahooti (2021). Runge-Kutta Five (https://www.mathworks.com/matlabcentral/fileexchange/60860-runge-kutta-five), MATLAB Central File Exchange. Retrieved November 15, 2021.
%--------------------------------------------------------------------------
function [y] = RK5(func, t, y_0, h)
F1 = func(t        , y_0          );

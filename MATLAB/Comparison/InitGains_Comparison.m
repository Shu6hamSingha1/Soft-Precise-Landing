...
%% SHARED-INNER-LOOP switch (2026-09-21) -- DEFAULT TRUE. false = each baseline's own geometric SO(3) torque law with kR_shared/kOmega_shared
...
K_Lin2022.shared_so3 = true;  K_Zhang2026.shared_so3 = true;  K_Lin2023.shared_so3 = true;  K_Cho2022.shared_so3 = true;   % DEFAULT ON (2026-09-21, user decision): identical attitude control for all five controllers; false = legacy per-baseline P-only law (kR_shared/kOmega_shared)

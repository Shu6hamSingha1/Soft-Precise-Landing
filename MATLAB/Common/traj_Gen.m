...
function [X] = traj_Gen(t, type, speed_mult)
    ...
    switch type
        ...
        case "Lissajous"
            ...
            B  = 0.8;
            w1 = -0.5 * speed_mult;
            w2 =  0.85 * speed_mult;      % restored to original 0.85 (reverts the 0.8 trim): the
                                          % lateral controller lift (chi_r 1.15->1.5, p_hinf 0.5->1.0)
                                          % handles the original Lissajous high-speed lateral precision

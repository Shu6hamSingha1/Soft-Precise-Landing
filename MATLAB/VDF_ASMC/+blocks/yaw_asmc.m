...
%   heading psi_d (no magnetometer). alpha is the 2pi-disambiguated principal
%   direction (image_feature.m); alpha_e is wrapped to (-pi,pi] via atan2, its sole
%   discontinuity at +-pi (unreachable in a landing). alpha_d (= V_s_d(4)) is the
%   aligned-pattern principal direction (pi/4 for the square marker), NOT zero.

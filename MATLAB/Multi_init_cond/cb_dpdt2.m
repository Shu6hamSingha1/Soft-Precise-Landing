function cb_dpdt2()
% Re-test with CONDITIONING-FIXED SG-derivative dPdt (fit vs sample index). Sanity:
% tol4 SG9 should ~match base 92 if the SG-deriv is sound. Key: does tol0.01 + SG-deriv
% fix Static IC5 seed4 WITHOUT the limit cycle? keep s_ddot 92-config.
    trajs={"Static","Linear","Sinusoidal","Lissajous","Circular"};
    ICs={[0;0;-5],[2;2;-5],[2;-2;-5],[2;2;-7],[2;2;-3]};
    cfgs={{'base tol4 raw',4,[]},{'tol4 SG9 (sanity)',4,9},{'tol0.01 SG9',0.01,9},{'tol0.01 SG13',0.01,13}};
    for c=cfgs
      ...
      fprintf('  %-18s: noiseless SP=%d/25 (resid %.2f) | noisy SP=%d/100 (resid %.2f) | S5s4 land=%d\n',...

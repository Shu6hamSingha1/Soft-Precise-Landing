function cb_suite_tau()
% Full 5x5 suite with FILTERED s_ddot (tau=0.5) vs the drop baseline (21/25).
% corrected c-h, chi_r=1, noiseless. Does filtering improve net soft+precise?
    ...
    fprintf('  >> TAU=0.5  SP=%d/25  landed=%d/25  (drop was SP=21/25)\n',SP,LD);
end

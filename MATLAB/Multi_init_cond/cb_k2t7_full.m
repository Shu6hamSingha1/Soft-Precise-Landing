function cb_k2t7_full()
% Responsive-s_ddot candidate: kR/kOmega x2 (inner-loop fix) + light tau=0.7. Full 5x5.
    ...
    fprintf('  >> kR x2 + tau0.7 (responsive keep-s_ddot)  SP=%d/25 land=%d/25 worstResid=%.3f\n',SP,LD,worst);
...
function d=run_one(ic,traj)
    ...
    KR_OVERRIDE=[3.0;3.0;0.5]; KOMEGA_OVERRIDE=[0.6;0.6;0.1];

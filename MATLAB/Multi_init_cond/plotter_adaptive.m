...
%% Extracting Solution
    ...
    parameters_2 = {'\textbf{Outer-Loop Control Parameters:}' ['$K_{rp' ...
        '}$ = diag([' num2str(K.rp(1,1)) ', ' num2str(K.rp(2,2)) ']), $K_{ri}$ = diag([' num2str(K.ri(1,1)) ...
        ', ' num2str(K.ri(2,2)) ']), $K_{rd}$ ' ...
        '= diag([' num2str(K.rd(1,1)) ', ' num2str(K.rd(2,2)) ']), $\mathbf{\gamma}_1$ = [' ...
    ...
    parameters_1 = {'\textbf{Outer-Loop Control Parameters:}' ['$K_{ep' ...
        '}$ = diag([' num2str(K.ep(1,1)) ', ' num2str(K.ep(2,2)) ']), ' ...
        '$K_{ei}$ = diag([' num2str(K.ei(1,1)) ', ' num2str(K.ei(2,2)) ...
        ']), $K_{ed}$ = diag([' num2str(K.ed(1,1)) ', ' num2str(K.ed(2,2)) '])']};
    figure(1);
    clf;

...
% step size
dt = 1/30; % [s]                 % 30 Hz becaz the camera works in 30 Hz
% Initial values
t0 = 0;
...
I_px_c = 1.0; I_py_c = 1.0; I_pz_c = -5.0;
...
tau_w   = 0.03;        % time constant [s] (20–50 ms recommended)
alpha_w = tau_w / (tau_w + dt);

% Constants related to Low-pass filter for B_dw_c
tau_dw   = 0.03;        % time constant [s] (20–50 ms recommended)

...
- [Never edit a .sh while it is executing](feedback_never_edit_running_bash_script.md) — bash reads incrementally; crashed a live harness 2026-09-24; pgrep first, or copy to a new file
- [ArUco path is OBSOLETE — cross-marker is the baseline; do not test/maintain ArUco](project_aruco_obsolete.md) — user decision 2026-09-26

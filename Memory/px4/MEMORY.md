...
- [⭐ Perception s goes STALE near touchdown: detect() cost scales with arm pixels, 49→12 Hz below 1 m](project_20260924_terminal_perception_rate_drop.md) — sperc-vs-GT A/B: 6/25 vs 25/25 manuscript SP; s accurate to 0.5 m; not decode failure; _scale/_shift tuple conversion + fitLine on ~5.6k pts

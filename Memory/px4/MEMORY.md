...
- [⭐ Stroke detector: STATIONARY SOLVED (25/25 SP, xy=GT), moving rate-bound; deck GT flaw](project_20260924_stroke_detector_rewrite.md) — CROSS_DETECTOR=stroke; sperc stationary 6/25->25/25; Sinusoidal 2.5 m->0.17 m (gt 0.04), limited by 48-80 ms live frame gap; deck GT target = rover

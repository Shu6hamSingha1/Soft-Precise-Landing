...
- [⛔ Ackermann rover does NOT track slow setpoints -- parks then loops at ~2 m/s](project_20260922_ackermann_rover_loops_not_tracking.md) — all 11 Lissajous_final reps GT peak 1.6-2.8 m/s vs 0.15 commanded; k=0.1 "RESOLVED" SP landed on a rover parked its final 6.5 s. Always compute target speed from Ground_Truth.npy.

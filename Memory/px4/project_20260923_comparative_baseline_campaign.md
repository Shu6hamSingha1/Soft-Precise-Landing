...
Still 1/10 "landed" (only `Linear`, xy=1.51m/1.30 m/s, actually a GROUND IMPACT 0.76m below deck level, 1.5m off-target, after an ascent excursion -- NOT deck contact; the earlier deck-heave guess was wrong) and 9/10 descent-stall aborts, vs 0/10 before. The
